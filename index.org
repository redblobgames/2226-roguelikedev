...
I broke this down into smaller parts. First, I wanted the agents to eat when they're hungry *and* they're walking over food.
...
So the next step is to have the chickens decide where to walk. If they're hungry, they'll look for nearby food. If they're not hungry, they'll pick a random place on the map.
