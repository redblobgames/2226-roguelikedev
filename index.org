...
Tangent: the same sprite in different colors could mean different things. So far my code loads a /sprite/ but then hard codes the colors. I want a mapping from tile type to sprite+color.
