...
Then I need to periodically go through all the plants/trees and make the grow.

A thought: my desire to keep everything fast is getting in my way. Premature optimization? No, I am /sure/ I need to optimize this. But still, it's getting in my way. In particular, I often want to build an /index/:
...
In RimWorld and Two Point Hospital, the job objects reserve space for standing. I think that's a good idea, but I don't yet have job objects (carpenter table, kitchen stove, etc.).
...
<x:footer>
  Created 28 Jun 2022; &#160;
  <!-- hhmts start -->Last modified: 20 Jul 2022<!-- hhmts end -->
</x:footer>
#+end_export
